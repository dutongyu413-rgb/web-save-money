import { ChartBar, Database, DownloadSimple, Globe, ShieldCheck } from "@phosphor-icons/react";
    ...
    <section className="screen info-screen">
      ...
      <div className="screen-scroll">
        ...
        <div className="info-list">
          ...
          <article><ChartBar /><div><h3>匿名使用统计</h3><p>仅记录页面访问和关键功能是否成功使用，不记录收入、储蓄、日期、备注、目标数值、密码或备份内容。</p></div></article>
        </div>
